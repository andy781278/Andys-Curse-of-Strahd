...
- The Weaver of the Swamp Fane represents the remembrance of the past
...
- shrine is the circle of stones in Berez.

### The Huntress of the Mountain Fane
- The Huntress of the Mountain Fane represents the acceptance of the present
- nature based death god, accept death 
...
- shrine is the circle atop Yesterhill.
- Worshipped by werewolves

### The Seeker of the Forest Fane
- The Seeker of the Forest Fane represents the coming of the future
- sees the future
...
- shrine is the collection of monoliths behind Old Bonegrinder.
- Worshipped by wereravens



The ladies are non-physical, extrasensory beings that represent the land. They would appear in auguries, dreams, and omens, speaking through the mouths of animals and in the wind that mused the leaves on the trees. 
- The forest folk of old used to worship them, but the religious fervor has long since died down, nowadays only scholars and certain forest folk knows about them. Even lesser knew about how to reinstate them.

People who knows of the fanes:
- all forest folks
- all werewolves
- some wereravens
	- The Martikovs
- a little vistanis
- the druids at yester hill
- Highly Educated
	- Amber Temple and Exethanter the Lich
	- Richten and Esmeralda
	- Lady Watcher
	- Patrina Velikovna (dusk elf archmage)
	- Baba Lysaga
	- Strahd

People who knows how to reinstate the fanes:
- Fallen warrior spirits at yester hill
- Highly Educated
	- Amber Temple and Exethanter the Lich
	- Patrina Velikovna (dusk elf archmage)
	- Baba Lysaga
...
- The gems are inherently connected, and holding one and concentrating on it can give them clues for where the other gems are. They have to think of things corresponding to the past, present, or future, according to the fane.
- Weaver
	- Green
	- Hint: A vision of the town of Berez as it was being destroyed by Strahd
	- Embedded in Baba Lysaga's Hut.
- Huntress
	- Red
	- Hint: A vision of the druids as they are performing a ritual, next to them the fog that borders Boravia
	- Embedded in Strahd's statue in Yesterhill
- Seeker
	- Blue
	- Hint: A vision of Rahadin as he works in his office in Castle Boravia
	- In the hands of Rahadin, who can easily slot it into the skull of Argynvost, making it into a Dracolich, but no lair actions
	- https://5e.tools/bestiary/dracolich-xmm.html
...
- The people of the valley used to worship the Ladies through a series of shrines scattered across the land, some small and some large. The three most prominent shrines were located inside large stone circles that still stand during the present time of the campaign.
	...
	- The forest shrine is the collection of monoliths behind Old Bonegrinder.
- The worship of the Ladies usually came in the form of minor religious practices and offerings. The offerings were usually things like, "The best fruits from the first harvest" or "the antlers of a buck we killed on hunt." Sometimes the people left small, carved statues or other bits of artistic labor.
...
- Strahd managed to do so with the knowledge from Amber Temple and the help of Vampyr
- By taking over the Fanes, Strahd has the following benefits:
	- Mountain Fane: Strahd can alter terrain in a 30ft radius around him, such as erecting walls or pillars up to 20ft in each dimension. Strahd can create an earthquake in a mile radius that destroys most homes and gives every disadvantage on saves, attacks, and checks for 1 minute for all non-flyers. (1/day).
	- Forest Fane: Strahd gains control over all wolves, bats, and beasts in Barovia, excluding Ravens. He can also tap into their senses and give commands from anywhere in Barovia.
